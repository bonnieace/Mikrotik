...
def get_settings() -> Settings:
    settings = Settings(
        ...
        router_control_cidr=os.getenv("ROUTER_CONTROL_CIDR", "10.77.0.0/24"),
        router_allowed_cidrs=_csv("ROUTER_ALLOWED_CIDRS", os.getenv("ROUTER_CONTROL_CIDR", "10.77.0.0/24")),
